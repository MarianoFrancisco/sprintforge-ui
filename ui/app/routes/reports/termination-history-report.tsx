...
export default function TerminationHistoryReportRoute() {
  ...
  const {
    ...
    clearPdf,
    setError,
  } = usePdfReport(REPORT_ENDPOINTS.TERMINATION_HISTORY, {
    autoLoad: false,
    filename: "reporte-termination-history.pdf",
  });
  ...
  const handleDownload = () => {
    ...
    downloadPdf(`termination-history${range}.pdf`);
  };
    ...
    <section className="p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <header className="grid gap-3">
        <div className="space-y-1">
          <h1 className="text-xl md:text-2xl font-bold">Reporte de Bajas Empleados</h1>
          <p className="text-sm md:text-base text-muted-foreground">
            Genera, visualiza y descarga el reporte de bajas de empleados en PDF.
          </p>
        </div>
