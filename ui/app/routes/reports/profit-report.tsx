...
export const middleware: MiddlewareFunction[] = [
  permissionMiddleware([PERMS.REPORT_PROFITS], {
    flashMessage: "No tienes permiso para ver el reporte de ganancias."
  }),
];
...
export default function ProfitReportRoute() {
  ...
  const {
    ...
    clearPdf,
    setError,
  } = usePdfReport(REPORT_ENDPOINTS.PROFITS, {
    autoLoad: false,
    filename: "reporte-profit.pdf",
  });
    ...
    <section className="p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <header className="grid gap-3">
        <div className="space-y-1">
          <h1 className="text-xl md:text-2xl font-bold">Reporte de Ganancias</h1>
          <p className="text-sm md:text-base text-muted-foreground">
            Genera, visualiza y descarga el reporte de ganancias en PDF.
          </p>
        </div>
