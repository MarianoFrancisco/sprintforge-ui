...
export const navMainData: NavItem[] = [
  ...
  },
  {
    ...
    // permission: PERMS.PROJECT_VIEW,
    items: [
      {title: "Avance de proyectos", url: "/reports/project-progress"},
      { title: "Contrataciones", url: "/reports/hiring-history"},
      { title: "Bajas empleados", url: "/reports/termination-history"},
      { title: "Roles", url: "/reports/role-general"},
      { title: "Ingresos", url: "/reports/incomes"},
      { title: "ganancias", url: "/reports/profits"},
      { title: "Gastos", url: "/reports/expenses"},
    ],
  },
];